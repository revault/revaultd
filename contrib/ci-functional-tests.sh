...
REVAULTD_PATH=./target/release/revaultd EXECUTOR_WORKERS=2 VERBOSE=1 LOG_LEVEL=debug TIMEOUT=120 TEST_DEBUG=1 POSTGRES_USER="test" POSTGRES_PASS="test" pytest -vvv --timeout=1800 tests/
